  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">网上租车系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
												...
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">驾驶证编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiashizhengbianhao" class="input" type="text" placeholder="驾驶证编号">
			   </div>
			 </div> -->
			<el-form-item label="驾驶证编号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiashizhengbianhao" autocomplete="off" placeholder="驾驶证编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">住址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhuzhi" class="input" type="text" placeholder="住址">
			   </div>
			 </div> -->
			<el-form-item label="住址" class="input" v-if="tableName=='yonghu'">
