      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="车辆编号" prop="cheliangbianhao">
          <el-input v-model="ruleForm.cheliangbianhao" 
              placeholder="车辆编号" clearable ></el-input>
        </el-form-item>
        <div v-else>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.qicheleixing"
                placeholder="汽车类型" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.zhuangtai"
                placeholder="状态" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车龄" prop="cheling">
          <el-input v-model="ruleForm.cheling" 
              placeholder="车龄" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车龄" prop="cheling">
              <el-input v-model="ruleForm.cheling" 
                placeholder="车龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公里数" prop="gonglishu">
          <el-input v-model="ruleForm.gonglishu" 
              placeholder="公里数" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公里数" prop="gonglishu">
              <el-input v-model="ruleForm.gonglishu" 
                placeholder="公里数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="日租金" prop="rizujin">
              <el-input v-model="ruleForm.rizujin" 
                placeholder="日租金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="取车地址" prop="quchedizhi">
          <el-input v-model="ruleForm.quchedizhi" 
              placeholder="取车地址" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="取车地址" prop="quchedizhi">
              <el-input v-model="ruleForm.quchedizhi" 
                placeholder="取车地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="还车地址" prop="haichedizhi">
          <el-input v-model="ruleForm.haichedizhi" 
              placeholder="还车地址" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="还车地址" prop="haichedizhi">
              <el-input v-model="ruleForm.haichedizhi" 
                placeholder="还车地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='cheling'){
            this.ruleForm.cheling = obj[o];
            continue;
          }
                    if(o=='gonglishu'){
            this.ruleForm.gonglishu = obj[o];
            continue;
          }
                    if(o=='yajin'){
            ...
            continue;
                    ...
                    if(o=='quchedizhi'){
            this.ruleForm.quchedizhi = obj[o];
            continue;
          }
                    if(o=='haichedizhi'){
            this.ruleForm.haichedizhi = obj[o];
            continue;
          }
                    if(o=='xiangqing'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.zhuangtaiOptions = "待租,已租,维修中".split(',')
                                                                                                                                                          },
                                                                                                                        // 多级联动参数
                                                                                                                                                        info(id) {
      this.$http({
