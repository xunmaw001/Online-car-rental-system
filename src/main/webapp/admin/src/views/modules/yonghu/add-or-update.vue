  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="驾驶证编号" prop="jiashizhengbianhao">
          <el-input v-model="ruleForm.jiashizhengbianhao" 
              placeholder="驾驶证编号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="驾驶证编号" prop="jiashizhengbianhao">
              <el-input v-model="ruleForm.jiashizhengbianhao" 
                placeholder="驾驶证编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="住址" prop="zhuzhi">
              <el-input v-model="ruleForm.zhuzhi" 
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jiashizhengbianhao'){
            this.ruleForm.jiashizhengbianhao = obj[o];
            continue;
          }
                    if(o=='zhuzhi'){
