...
export default {
  ...
  computed: {
                                                                                                            zongjine:{
                                                                                                                                                                                                                                get: function () {
        return 1*this.ruleForm.zulintianshu*this.ruleForm.rizujin
      }
    },
                                                                          },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `haichexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.haichexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
