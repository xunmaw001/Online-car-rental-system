  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="车牌号" prop="chepaihao">
              <el-input v-model="ruleForm.chepaihao" 
                placeholder="车牌号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="故障分类" prop="guzhangfenlei">
          <el-select v-model="ruleForm.guzhangfenlei" placeholder="请选择故障分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="故障分类" prop="guzhangfenlei">
	      <el-input v-model="ruleForm.guzhangfenlei"
                placeholder="故障分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `guzhangshangbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.guzhangshangbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
